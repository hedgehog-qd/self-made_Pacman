...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
                      ...
                      _In_ int       nCmdShow)
{
	MessageBoxA(NULL, "您好！欢迎使用DSRL吃豆子游戏！您需要同意以下规则。若您同意，请点击“确定”继续。若您不同意，请退出。 \n 1.请您尊重原创作者，不要盗版重新发售 \n 2.本软件为开源软件，您可以研究，希望能给您带来帮助 \n 3.使用过程中有任何问题请联系我们： \n Email：hedgehog_qd@163.com \n  \n DSRL项目，来自hedgehog_qd lab", "提示--吃豆子游戏", MB_OK);
	MessageBoxA(NULL, "感谢您使用DSRL吃豆子游戏", "提示--吃豆子游戏", MB_OK);
    // 参数不再使用了
    ...
    while(!g_me->IsOver() && s_n < STAGE_COUNT) {
        ...
        if(g_me->IsWin()) {
            ...
            if(s_n < 3) {
                MessageBox(g_hwnd, _T("恭喜您已过关"), _T("提示--吃豆子"), MB_OK);
    ...
    // 如果游戏结束
    if(g_me->IsOver()) {
        MessageBoxA(NULL, "抱歉，您输了", "提示--吃豆子游戏", MB_OK);
    }
    // 否则,提示赢得游戏
    else {
        MessageBoxA(NULL, "恭喜您赢得了胜利\r\n单击“确定”即可退出游戏", "提示--吃豆子游戏", MB_OK);
    }
